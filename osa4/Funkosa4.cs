...
namespace osa4
{
    internal class Funkosa4
    {
        public static void Kirjuta_failisse()
        {
            try
            {
                string path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Kuud.txt"); //@"..\..\..\Kuud.txt" //AppDomain.CurrentDomain.BaseDirectory, "Kuud.txt"
        ...
        public static void loemefaili(string failinimi)
        {
            try
            {
